...
<div class="box">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            ...
            <a href="{{route('categoria.create')}}" class="btn btn-box-tool" data-toggle="tooltip" data-original-title="Agregar Categoría">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Gestione las diferentes Categorías de Estudiantes ej: ANTIGUO, ESPECIAL.</p>
            </div>
