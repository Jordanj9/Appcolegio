            ...
            <form class="form" role='form' method="POST" action="{{route('categoria.store')}}">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Descripción de la Categoría (opcional)" name="descripcion">
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Agregue nuevas categorías, la descripción es opcional y el campo nombre debe llevar máximo 50 caracteres.</p>
            </div>
