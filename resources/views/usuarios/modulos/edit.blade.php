...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('modulo.index')}}"><i class="fa fa-clone"></i> Módulos</a></li>
            ...
            <form class="form" role='form' method="POST" action="{{route('modulo.update',$modulo->id)}}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" required="required" name="nombre" value="{{$modulo->nombre}}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Descripción (opcional)</label>
                        <input class="form-control" type="text" name="descripcion" value="{{$modulo->descripcion}}">
                    </div>
                </div>
