...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">EDITAR NIVEL SOCIECONOMICO</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('estrato.update',$estrato->id)}}">
                @csrf
                <input name="_method" type="hidden" value="PUT" />
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Etiqueta</label>
                        <input class="form-control" type="text" placeholder="Nivel del estrato" required="required" name="etiqueta" value="{{$estrato->etiqueta}}">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Gestione los diferentes tipos de niveles socieconomicos. Edite los datos del nivel seleccionado.</p>
            </div>
