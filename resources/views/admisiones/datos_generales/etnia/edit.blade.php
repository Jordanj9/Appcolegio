...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">EDITAR ETNIA</h3>
            ...
            <form class="form" role='form' method="POST" action="{{route('etnia.update',$etnia->id)}}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input class="form-control" type="text" placeholder="Nombre de la etnia" required="required" name="nombre" value="{{$etnia->nombre}}">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
                        <label>Descripciòn</label>
                        <input class="form-control" type="text" placeholder="Descripción de la etnia" name="descripcion" value="{{$etnia->descripcion}}">
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Gestione los diferentes tipos de etnias que existen en colombia. Edite los datos de la etnia seleccionada.</p>
            </div>
