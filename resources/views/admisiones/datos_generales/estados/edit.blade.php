            ...
            <form class="form" role='form' method="POST" action="{{route('estado.update',$estado->id)}}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" required="required" name="nombre" value="{{$estado->nombre}}">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Edite los datos de los estados, recuerde que los campos código, pais y nombre son requeridos.</p>
            </div>
