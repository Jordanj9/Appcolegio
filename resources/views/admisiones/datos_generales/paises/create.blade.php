...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">CREAR NUEVO PAIS</h3>
            ...
            <form class="form" role='form' method="POST" action="{{route('pais.store')}}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Ejemplo: para colombia el código sería SURAMERICA" name="region">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="continente">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" placeholder="Porcentaje sobre 100 que indique la probabilidad de la expectativa de vida" name="expectativa_vida">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Producto Interno Bruto (Opcional)</label>
                        <input class="form-control" type="number" name="producto_interno_bruto">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Producto Interno Bruto Antiguo (Opcional)</label>
                        <input class="form-control" type="number" name="producto_interno_bruto_antiguo">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Nombre Local (Opcional)</label>
                        <input class="form-control" type="text" placeholder="Nombre que se le asigna a una nación internamente" name="nombre_local">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Tipo de Gobierno (Opcional)</label>
                        <input class="form-control" type="text" placeholder="Tipo de gobierno: Estado Federal, Republica Democratica, etc." name="gobierno">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Jefe de Estado(Opcional)</label>
                        <input class="form-control" type="text" name="jefe_estado">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Código Segundo (Opcional)</label>
                        <input class="form-control" type="text" placeholder="Ejemplo: para colombia el código sería CO, abrebiatura de dos caracteres" name="codigo_dos">
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Agregue nuevos paises. Los paises son usados para funciones de admisiones y otros.</p>
            </div>
