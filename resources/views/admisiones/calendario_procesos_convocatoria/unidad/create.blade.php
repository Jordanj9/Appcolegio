...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">CREAR NUEVA UNIDAD</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('unidad.store')}}">
                @csrf
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input class="form-control" type="text" placeholder="Nombre de la unidad" required="required" name="nombre">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Descripción</label>
                        <input class="form-control" type="text" placeholder="Descripción de la unidad" name="descripcion">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Agregue nuevas unidades. Las unidades son las diferentes sedes con las que cuenta la institución, como: (Unidad Operativa Cúcuta, Unidad Ocaña, Sede Central, etc.</p>
            </div>
