...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('convocatoria.update',$convocatoria->id)}}">
                @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Cupo</label>
                        <input class="form-control" type="number" required="required" name="cupo" value="{{$convocatoria->cupo}}">
                    </div>
                </div>
                <div class="col-md-12" style="margin-top: 20px !important">
                    <div class="form-group">
                        ...
                        <a class="btn btn-danger icon-btn pull-left" href="{{route('convocatoria.index')}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Edite los datos de la convocatoria. Gestione las convocatorias de inscripción, sus estados y asociela a los grados.</p>
            </div>
