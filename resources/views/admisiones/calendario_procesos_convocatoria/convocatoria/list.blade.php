...
<ol class="breadcrumb">
    ...
    <li class="active"><a>Convocatorias</a></li>
</ol>
@endsection
@section('content')
<div class="box">
            ...
            <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('convocatoria.show',$p->id)}}" style="margin-left: 10px;" data-toggle="tooltip" title="Continuar" style="margin-left: 10px;"><i class="fa fa-arrow-right"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
