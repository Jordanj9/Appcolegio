...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">CREAR NUEVO GRADO ACADÉMICO</h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('gradoacademico.store')}}">
                @csrf
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Etiqueta</label>
                        <input class="form-control" type="text" placeholder="Ej: Prejardin, jardin,1,2,3,4, etc." required="required" name="etiqueta">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Descripción</label>
                        <input class="form-control" type="text" placeholder="Descripción del grado" name="descripcion">
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Gestione los diferentes grados o años escolares que maneje la institución. Agregue un nuevo grado.</p>
            </div>
