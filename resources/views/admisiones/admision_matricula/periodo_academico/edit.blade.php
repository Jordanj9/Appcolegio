        ...
        <div class="col-md-12">
            <form class="form" role='form' method="POST" action="{{route('periodo.update',$periodo->id)}}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Año</label>
                        <input class="form-control" type="number" max="4" placeholder="Año" required="required" name="anio" value="{{$periodo->anio}}>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Fecha Inicio</label>
                        <input class="form-control" type="date" placeholder="Fecha de inicio del período" required="required" name="fechainicio" value="{{$periodo->fechainicio}}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Fecha Fin</label>
                        <input class="form-control" type="date" placeholder="Fecha fin del período" name="fechafin" value="{{$periodo->fechafin}}">
                    </div>
                </div>
